...
export const logEnter = () => {
    const a = [{ event: '705', label: '705-20200224kjyq' }];
    a.map(i => {
        try {
...
export const logDoLittleThings = () => {
    try {
        PALifeOpenH5.addRecord('705-5-6', `7050505-20200224kjyq`);
        track('705-5-6', `7050505-20200224kjyq`);
    } catch (err) {
        console.log(err);
    }
};
...
export const logClickPlayVideoBtn = () => {
    try {
        PALifeOpenH5.addRecord('705-7', `70507-20200224kjyq`);
        track('705-7', `70507-20200224kjyq`);
    } catch (err) {
        console.log(err);
    }
};
