<template>
    <div class="home-page">
        ...
        <div class="top-bar">
            <div class="video-player-div">
                <div>
                    ...
                    <video-player class="video-player vjs-custom-skin" ref="videoPlayer1" :playsinline="playsinline" :options="playerOptions" @play="onPlayerPlay"> </video-player>
        ...
        <div class="container">
            ...
            <div class="topic topic-1">
                ...
                <div class="topic-1-list">
                    <div v-for="(item, index) in topic1" :class="['topic-1-item', index == 0 ? 'active' : '']" :key="index" @click="jump(item.type, item.url)">
            ...
            <div class="topic topic-2">
                ...
                <div class="topic-item shadow" v-for="(item, index) in topic3" :key="index" @click="jump(item.type, item.url)">
                    <img class="topic-img-2" :src="item.img" />
                    <div> <span class="icon" v-if="item.icon"></span>{{ item.content }} </div>
                </div>
                <div
                    class="see-more"
                    @click="
        ...
        <van-action-sheet v-model="showFighting" title="为大家舍小家 致敬逆行英雄">
            <div class="wrap">
                <div class="fighting-item" v-for="(item, index) in content" :key="index" @click="sendWish(item)">
                    {{ item }}
                </div>
            </div>
        </van-action-sheet>
        <div class="all-video-div" v-if="show">
            <div style="position: relative">
                ...
                <video-player class="video-player vjs-custom-skin" ref="videoPlayer2" :playsinline="playsinline" :options="playerOptions2"> </video-player>
            </div>
        </div>
    </div>
</template>
        ...
        return {
            ...
            topic3: [
                {
                    ...
                    type: 9,
                    url: isInWeChat
                        ? 'https://ulink.lifeapp.pingan.com.cn/index.html?url=pars%3A%2F%2Fpars.pingan.com%2Flive%2Froom%3FliveId%3D2325816'
                        : 'pars://pars.pingan.com/mc/video_live_detail?liveid=2325816'
                },
                {
            ...
            topic1: [
                ...
                },
                {
                    ...
                    type: 2,
                    url: isInWeChat
                        ? 'https://ulink.lifeapp.pingan.com.cn/index.html?url=pars%3A%2F%2Fpars.pingan.com%2Fmc%2Fnew_hcz_auth_page%3FpluginName%3D%25e5%25b9%25b4%25e6%25a3%2580%25e4%25bb%25a3%25e5%258a%259e%26url%3Dpars%253a%252f%252fpars.pingan.com%252fhealthcircle%252fcar_plugin_with_car_manage%253ftype%253dAnnualInspection%2526title%253d%2525E5%2525B9%2525B4%2525E6%2525A3%252580%2525E4%2525BB%2525A3%2525E5%25258A%25259E'
                        : 'pars://pars.pingan.com/mc/new_hcz_auth_page?pluginName=%e5%b9%b4%e6%a3%80%e4%bb%a3%e5%8a%9e&url=pars%3a%2f%2fpars.pingan.com%2fhealthcircle%2fcar_plugin_with_car_manage%3ftype%3dAnnualInspection%26title%3d%25E5%25B9%25B4%25E6%25A3%2580%25E4%25BB%25A3%25E5%258A%259E'
                },
                {
            ...
            playerOptions: {
                ...
                poster: 'https://cos-1257316466.cos.ap-shanghai.myqcloud.com/6a5b3469815442f58e7b67bebb5876db_10@2x.png', //你的封面地址
                ...
                sources: [
                    {
                        ...
                        type: 'video/mp4',
                        //url地址
                        src: ' https://cos-1257316466.cos.ap-shanghai.myqcloud.com/c47483a0399c4e8fb9115a95e5700876_0225allv1.m4v'
                    }
                ],
                //允许覆盖Video.js无法播放媒体源时显示的默认信息。
                notSupportedMessage: '此视频暂无法播放，请稍后再试',
